...
def build_graph():
	...
	train_c = tf.train.RMSPropOptimizer(0.0025).minimize(c_loss,var_list=var_c1)
	train_a = tf.train.RMSPropOptimizer(0.0005).minimize(a_loss,var_list=var_a1) #maximize c_real2 , env_act1
...
with tf.Session() as sess:
	...
	while True:
		...
		#print (chance)
		if  chance < var: 
			act = np.random.randint(7, size=1)
		act1 = np.rint(np.clip(act,0,7))
		#print (act)
